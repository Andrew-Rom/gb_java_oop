    ...
    public static void createTeams() {
        ...
        for (int i = 1; i < Main.GANG_SIZE + 1; i++) {
            switch (new Random().nextInt(4)) {
                case 0 -> Main.teamWhite.add(new Monk(getName(), 1, i));
                case 1 -> Main.teamWhite.add(new XBowMan(getName(), 1, i));
                case 2 -> Main.teamWhite.add(new Spearman(getName(), 1, i));
                default -> Main.teamWhite.add(new Peasant(getName(), 1, i));
            }
        }
        ...
        for (int i = 1; i < Main.GANG_SIZE + 1; i++) {
            switch (new Random().nextInt(4)) {
                case 0 -> Main.teamBlack.add(new Witch(getName(), 10, i));
                case 1 -> Main.teamBlack.add(new Sniper(getName(), 10, i));
                case 2 -> Main.teamBlack.add(new Bandit(getName(), 10, i));
                default -> Main.teamBlack.add(new Peasant(getName(), 10, i));
            }
        }
